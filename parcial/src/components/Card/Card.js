        ...
        return(
             <article className="single-card-movie">
                ...
                <div className="cardBody">
                    ...
                    {this.props.logueado ? <div className="btn alert-primary" onClick={() => this.state.esFavorito ? this.sacarDeFavoritos() : this.agregarAFavoritos()}>{this.state.esFavorito ? '♥️' : '♡'}</div> : ''}
                </div>
            </article>
        )
    }
